...
import { WiDirectionDown, WiDirectionDownLeft, WiDirectionDownRight, WiDirectionLeft, WiDirectionRight, WiDirectionUp, WiDirectionUpLeft, WiDirectionUpRight } from 'react-icons/wi';

const formatXAxis = (data) => `${new Date(data*1000).getHours()}시`
const CustomizedLabel = ({x, y, value}) => <text
    x={x+30} y={y-2} fontSize="15" textAnchor="middle">
    {value}m/s
</text>
...
const CustomizedContent = ({x,y,value}) => <WindDirection degree={value} x={x+15} y={y-30} fontsize={30} />
...
function BarGraph({num}) {
    ...
    >
        ...
        <Bar dataKey="wind_speed" fill="#00dd93" isAnimationActive={false} label={<CustomizedLabel />}>
