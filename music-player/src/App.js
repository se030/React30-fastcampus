...
function App() {
  ...
  const changeVolume = useCallback((volume) => audioRef.current.changeVolume(volume), []);
  const resetDuration = useCallback(() => audioRef.current.resetDuration, []);
  ...
  return (
    <div className="App">
      <div className="container" >
        ...
        <Controls setshowPlayList={setshowPlayList} 
          play={onPlay} pause={onPause} 
          changeVolume={changeVolume} resetDuration={resetDuration} />
